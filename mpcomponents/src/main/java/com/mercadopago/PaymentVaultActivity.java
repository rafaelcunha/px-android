...
public class PaymentVaultActivity extends AppCompatActivity {
    ...
    private void restartWithSelectedItem(PaymentMethodSearchItem groupIem) {
        ...
        startActivityForResult(intent, MercadoPagoComponents.PAYMENT_VAULT_REQUEST_CODE);
    ...
    protected void startNextStepForPaymentType(PaymentMethodSearchItem item) {
        ...
        MercadoPagoComponents.Builder builder = new MercadoPagoComponents.Builder()
                .setActivity(this)
                .setPublicKey(mMerchantPublicKey)
    ...
    public void onActivityResult(int requestCode, int resultCode, Intent data) {
        ...
        if(requestCode == MercadoPagoComponents.CARD_VAULT_REQUEST_CODE) {
        ...
        else if (requestCode == MercadoPagoComponents.PAYMENT_VAULT_REQUEST_CODE) {

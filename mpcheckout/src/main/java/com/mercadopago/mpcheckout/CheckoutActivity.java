package com.mercadopago.mpcheckout;
...
import com.mercadopago.mpservices.exceptions.CheckoutPreferenceException;
import com.mercadopago.exceptions.ExceptionHandler;
import com.mercadopago.mpservices.exceptions.MPException;
import com.mercadopago.mpcheckout.fragments.ShoppingCartFragment;
...
import com.mercadopago.mpservices.model.PaymentMethodSearchItem;
...
import com.mercadopago.mpservices.util.CurrenciesUtil;
...
public class CheckoutActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        if(mDecorationPreference != null && mDecorationPreference.hasColors()) {
            setTheme(com.mercadopago.R.style.Theme_MercadoPagoTheme_NoActionBar);
        }
    ...
    private void getCheckoutPreference() {
        showProgress();
        mMercadoPagoServices.getPreference(mCheckoutPreferenceId, new Callback<CheckoutPreference>() {
            @Override
            ...
            public void failure(ApiException apiException) {
                ...
                if (mActiveActivity) {
                    ErrorUtil.showApiExceptionError(mActivity, apiException);
    ...
    protected void getPaymentMethodSearch() {
        showProgress();
        mMercadoPagoServices.getPaymentMethodSearch(mCheckoutPreference.getAmount(), mCheckoutPreference.getExcludedPaymentTypes(), mCheckoutPreference.getExcludedPaymentMethods(), new Callback<PaymentMethodSearch>() {
            @Override
    ...
    protected void onActivityResult(int requestCode, int resultCode, Intent data) {
        if(requestCode == MercadoPagoComponents.PAYMENT_VAULT_REQUEST_CODE) {
            resolvePaymentVaultRequest(resultCode, data);
        }
        else if (requestCode == MercadoPagoComponents.INSTRUCTIONS_REQUEST_CODE) {
            finishWithPaymentResult();
        }
        else if (requestCode == MercadoPagoComponents.CONGRATS_REQUEST_CODE) {
            resolveCongratsRequest(resultCode, data);
        }
        else if (requestCode == MercadoPagoComponents.INSTALLMENTS_REQUEST_CODE) {
    ...
    protected void resolveInstallmentsRequest(int resultCode, Intent data) {
        ...
        overridePendingTransition(com.mercadopago.R.anim.slide_left_to_right_in, com.mercadopago.R.anim.slide_left_to_right_out);
    }
        ...
        if(!isUniquePaymentMethod()) {
            mPaymentMethodRow.setOnClickListener(new View.OnClickListener() {
                ...
                public void onClick(View v) {
                    ...
                    startPaymentVaultActivity();
                    overridePendingTransition(com.mercadopago.R.anim.slide_right_to_left_in, com.mercadopago.R.anim.slide_right_to_left_out);
                }
            });
        }
    }
    ...
    protected void createPayment() {
        ...
        mMercadoPagoServices.createPayment(paymentIntent, new Callback<Payment>() {
            @Override
    ...
    private void resolvePaymentFailure(ApiException apiException) {
        if(apiException.getStatus() != null) {
            ...
            if (String.valueOf(apiException.getStatus()).startsWith(serverErrorFirstDigit)
                ...
                ErrorUtil.showApiExceptionError(this, apiException);
                failureRecovery = new FailureRecovery() {
                    @Override
                    public void recover() {
                        createPayment();

...
public class InstallmentsActivity extends ShowCardActivity {
    ...
    protected void initializeFragments(Bundle savedInstanceState) {
        ...
        super.initializeCard(mCardInfo, mPaymentMethod);
    ...
    private void setCardInformation(Card card, Token token) {
        if (card != null) {
            mCardInfo = card;
        } else if (token != null) {
            mCardInfo = token;
    ...
    protected void validateActivityParameters() throws IllegalStateException {
        ...
        if (mPayerCosts == null) {
            ...
            if (mPaymentMethod == null) throw new IllegalStateException("payment method is null");
        }
    }
    ...
    private void getInstallmentsAsync() {
        ...
        String bin = mCardInfo.getFirstSixDigits() == null ? "" : mCardInfo.getFirstSixDigits();

...
public class PaymentVaultActivity extends MercadoPagoActivity implements PaymentVaultView {
    ...
    private PaymentVaultPresenter mPaymentVaultPresenter;
...
//                .startPaymentVaultActivity();
    ...
    //TODO mandar sólo MPEXCEPTION y unificar!
    @Override
    public void showError(String errorMessage, boolean recoverable) {
        ErrorUtil.startErrorActivity(this, errorMessage, recoverable);
    }

    @Override
    public void showError(String errorMessage, String errorDetail, boolean recoverable) {
        ErrorUtil.startErrorActivity(this, errorMessage, errorDetail, recoverable);
    }

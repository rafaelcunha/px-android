...
public class InstallmentsOldActivity extends ShowCardActivity {
                    ...
                    public void success(List<Installment> installments) {
                        if (isActivityActive()) {
                            ...
                            if (installments.size() == 0) {
                                ErrorUtil.startErrorActivity(getActivity(), getString(R.string.mpsdk_standard_error_message), "no installments found for an issuer at InstallmentsOldActivity", false);
                            } else if (installments.size() == 1) {
                                resolvePayerCosts(installments.get(0).getPayerCosts());
                            } else {
                                ErrorUtil.startErrorActivity(getActivity(), getString(R.string.mpsdk_standard_error_message), "multiple installments found for an issuer at InstallmentsOldActivity", false);
                            }
                        }
                    }
    ...
    private void resolvePayerCosts(List<PayerCost> payerCosts) {
        ...
        if (defaultPayerCost != null) {
            ...
            ErrorUtil.startErrorActivity(getActivity(), getString(R.string.mpsdk_standard_error_message), "no payer costs found at InstallmentsOldActivity", false);

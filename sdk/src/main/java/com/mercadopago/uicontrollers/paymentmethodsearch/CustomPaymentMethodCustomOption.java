...
public class CustomPaymentMethodCustomOption implements PaymentMethodSearchViewController {
    ...
    public CustomPaymentMethodCustomOption(Context context, CustomSearchItem item) {
        mContext = context;
        mItem = item;
    }

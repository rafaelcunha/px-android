...
public class CardToken implements Serializable {
    ...
    public void validateCardNumber(Context context, PaymentMethod paymentMethod) throws Exception {
        ...
        Setting setting = Setting.getSettingByBin(paymentMethod.getSettings(), (cardNumber.length()
                >= MercadoPagoServices.BIN_LENGTH ? cardNumber.substring(0, MercadoPagoServices.BIN_LENGTH) : ""));
    ...
    public void validateSecurityCode(Context context, PaymentMethod paymentMethod) throws Exception {
        ...
        validateSecurityCode(context, securityCode, paymentMethod, (((cardNumber != null) ? cardNumber.length() : 0) >= MercadoPagoServices.BIN_LENGTH ? cardNumber.substring(0, MercadoPagoServices.BIN_LENGTH) : ""));
    }
